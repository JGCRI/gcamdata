...
module_energy_L223.electricity <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L223.GlobalTechCapital_elec %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$US/kw")) %>%
    ...
    L223.GlobalTechOMfixed_elec %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$US/kw/year")) %>%
    ...
    L223.GlobalTechOMvar_elec %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$US/kw/MWh")) %>%
    ...
    L223.GlobalIntTechBackup_elec %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$US/kw/yr")) %>%
    ...
    L223.GlobalTechCapital_sol_adv %>%
      ...
      add_units(paste0("capital overnight - ", CURRENCY_YEAR, "USD/GJ, capacity factor - unitless, fixed.charge.rate - unitless")) %>%
