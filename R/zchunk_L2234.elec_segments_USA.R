...
module_gcamusa_L2234.elec_segments_USA <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    L2234.GlobalTechCapital_elecS %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$ per kW; unitless (fixed.charge.rate)")) %>%
    ...
    L2234.GlobalTechOMfixed_elecS %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$/kW/yr")) %>%
    ...
    L2234.GlobalTechOMvar_elecS %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$/MWh")) %>%
    ...
    L2234.GlobalIntTechBackup_elecS %>%
      ...
      add_units(paste0(CURRENCY_YEAR, "$/kW/yr (backup.capital.cost); unitless")) %>%
