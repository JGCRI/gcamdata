...
module_energy_LA114.wind <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    Zhou_wind_supply_ctry_EJ %>%
      ...
      # Convert prices per unit of energy from USD/kWh to USD/GJ
      mutate(mid.price = mid.price / CONV_KWH_GJ,
             base.price = base.price / CONV_KWH_GJ) ->
  ...
  # ===================================================
    ...
    add_units(paste0("Energy in EJ, price per unit energy in $", CURRENCY_YEAR, "/GJ")) %>%
