#' module_emissions_batch_all_fgas_emissions.xml
#'
...
#' original data system was \code{batch_all_fgas_emissions.xml.R} (emissions XML).
module_emissions_batch_all_fgas_emissions.xml_DISABLED <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    ...
    create_xml("all_fgas_emissions.xml") %>%
      ...
      add_precursors("L241.hfc_all", "L241.pfc_all", "L241.hfc_future", "L241.fgas_all_units", "L252.MAC_higwp") ->
